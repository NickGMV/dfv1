...
!function set_up_ids(){
			...
			to_tag[i].innerHTML += "<div id = edit_button" + i + "> <button title = 'enable popups on this domain to use this feature' onclick='opener.engage_edit_mode(); localStorage.position="+ i + "'>edit mode</button> </div>";	
